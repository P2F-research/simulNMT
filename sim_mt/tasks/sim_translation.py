...
class SimTranslationTask(FairseqTask):
    ...
    def update_step(self, step: int):
        # HUGE TODO TODO TODO
        #   in this case, when just loading ckpt, self._step won't be updated
        #   this will result in wrong k if you keep stopping experiment and loading ckpt
        #   However, this cannot be easily fixed unless change the src code or change fairseq version.
        #   fairseq v0.8.0 is full of bugs!!!!!!!!!!!!!!
        self._step = step
